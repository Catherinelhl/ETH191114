...
//    val address = "0x07757733653a6670a4f7b8d30704378cb4cf89b2"//等待查询余额的地址
        val address = "0xb72c794effb775197287d767ca80c22ae9094cb5&decimal=18&value=0"//等待查询余额的地址
        //第二个参数：区块的参数，建议选最新区块
        val balance = web3j.ethGetBalance(address, DefaultBlockParameterName.EARLIEST).send()
        //格式转化 wei-ether
        val balanceETH =
            Convert.fromWei(
